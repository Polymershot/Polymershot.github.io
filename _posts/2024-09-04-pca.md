...
\large{\frac{\partial \mathcal{L}}{\partial \lambda}} &=&  \large{W^TW - 1} \\\\\\
\large{\frac{\partial W}{\partial \lambda}} &=& \large{2VW - 2\lambda W} \\\\\\
\large{W^T W} &=& \large{1} &\text{Set the partial derviateives to 0 to solve for the unknown variables} \\\\\\
\large{VW} &=& \large{\lambda W} 
\end{align}
$$
</p>

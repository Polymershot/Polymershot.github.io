...
<https://math.libretexts.org/Bookshelves/Linear_Algebra/A_First_Course_in_Linear_Algebra_(Kuttler)/07%3A_Spectral_Theory/7.01%3A_Eigenvalues_and_Eigenvectors_of_a_Matrix>. However, trying to find the eigenvalues for V will yield p eigenvalues since V is a pxp covariance matrix. So, which one do we choose? 

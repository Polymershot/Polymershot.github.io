...
**Note**: For more information, visit <https://www.thescientificteen.org/post/multivariable-calculus-lagrange-multipliers> for a quick summary.

**Lagrange Multiplier**
1. First, you need to setup something called a Lagrangian. It should be in the following form: $\mathcal{L}(x,y,...,\lambda) = f(x) - g(x)$.

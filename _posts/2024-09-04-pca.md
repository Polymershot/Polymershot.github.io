...
\large{\frac{\partial W}{\partial \lambda}} &=& \large{2VW - 2\lambda W} \\[10pt]
\large{W^T W} &=& \large{1} &\text{Set the partial derviateives to 0 to solve for the unknown variables} \\[10pt]

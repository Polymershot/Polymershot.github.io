...
\\
\large{\lvert x_i \rvert} \longrightarrow \large{\sqrt{x^2_1 + x^2_2...}} &\text{Basically, square the coordinates of the data points and add them all up; then take the square root at the end. Sometimes called taking the **norm**))} \\
\\
